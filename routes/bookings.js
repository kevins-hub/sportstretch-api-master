...
router.post("/", auth, async (req, res) => {
  try {
    ...
    const newBooking = await pool.query(
      "INSERT INTO tb_bookings (fk_athlete_id, athlete_location, fk_therapist_id) VALUES ($1, $2, $3) RETURNING bookings_id, booking_time",
      [athlete_id, athlete_location, therapist_id]
    );
    res.status(201).send({
